...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#f7f5f0] text-[#171717]">
      ...
      {/* HEADER */}
      <header className="sticky top-0 z-50 border-b border-black/5 bg-[#f7f5f0]/90 backdrop-blur-xl">
        ...
        <div className="mx-auto grid min-h-[720px] max-w-7xl items-center gap-12 px-6 py-20 lg:grid-cols-2 lg:px-10 lg:py-24">
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="rounded-full border border-black/15 bg-white/30 px-7 py-3.5 text-sm font-medium tracking-wide transition hover:border-black hover:bg-white"
              >
                MESSAGE AUREON
              </a>
          ...
          <div className="relative flex min-h-[450px] items-center justify-center lg:min-h-[580px]">
            ...
            <div className="aureon-glass aureon-shadow relative flex h-[440px] w-[340px] items-center justify-center overflow-hidden rounded-[2rem] sm:h-[510px] sm:w-[390px]">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-white/70 via-transparent to-[#d8c7a9]/10" />
      ...
      <section
        id="about"
        className="border-t border-black/5 bg-white/85"
      >
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10 lg:py-32">
          ...
          <div className="mt-16 grid gap-8 lg:grid-cols-3">
            ...
            {products.map((product) => (
              ...
              <article
                key={product.name}
                className="group overflow-hidden rounded-[2rem] border border-black/10 bg-white/90 shadow-sm transition duration-500 hover:-translate-y-1 hover:shadow-[0_25px_70px_rgba(0,0,0,0.08)]"
              >
      ...
      >
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10 lg:py-32">
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_0.8fr]">
            ...
            <div className="rounded-3xl border border-black/10 bg-white/90 p-8 sm:p-10">
