...
const products = [
  ...
  },
  {
    ...
    identity:
      "Aurà™ is Aureon’s product identity for GHK-Cu, also known as copper tripeptide-1. GHK-Cu is a copper-binding tripeptide composed of glycine, histidine, and lysine.",
    scientific:
    ...
    batch:
      "Applicable Aurà™ products are identified through their lot or batch number, manufacturing date, expiration date, strength, and applicable product documentation.",
    storage:
      "Storage requirements are product-specific and should be followed according to the applicable product labeling and documentation.",
    tone: "gold",
  },
...
const faqGroups = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "The Aureon collection currently features Tirzèra™ / Tirzepatide, Retèra™ / Retatrutide, and Aurà™ / GHK-Cu. Product presentations and availability may vary.",
      },
      {
...

  {
    ...
    items: [
      ...
      {
        question:
          "What is the difference between Aurà™ and the other Aureon products?",
        answer:
          "Aurà™ / GHK-Cu has a different molecular identity and biological profile. GHK-Cu is a copper-binding tripeptide, while tirzepatide and retatrutide are peptide compounds associated with specific receptor pathways.",
      },
    ],
  },
...

  {
    ...
    items: [
      ...
      {
        question:
          "Can Aureon help me understand the differences between products?",
        answer:
          "Yes. Aureon provides scientific and product information describing the identity, characteristics, and distinctions between Tirzèra™, Retèra™, and Aurà™.",
      },
      {
...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#f8f7f4] text-[#171717]">
      ...
      {/* STAY CONNECTED */}
      <section className="relative overflow-hidden bg-[#e8dfd0]">

        <div className="absolute -right-32 -top-32 h-96 w-96 rounded-full bg-white/40 blur-3xl" />

        <div className="relative mx-auto max-w-5xl px-6 py-24 text-center lg:px-10 lg:py-28">
          ...
          <p className="mx-auto mt-6 max-w-xl text-sm leading-7 text-black/55">
            Subscribe to receive Aureon updates, product announcements,
            current promotions, new releases, and exclusive news.
          </p>


          {/* READY FOR BREVO CONNECTION */}
          ...
          <div className="mx-auto mt-10 flex max-w-xl flex-col gap-3 sm:flex-row">
            ...
            <input
              ...
              className="min-h-[52px] flex-1 rounded-full border border-black/10 bg-white px-6 text-sm outline-none transition placeholder:text-black/30 focus:border-[#8b7350]"
            />

            <button
              type="button"
              className="min-h-[52px] rounded-full bg-[#171717] px-8 text-xs font-medium tracking-[0.15em] text-white transition hover:bg-[#333]"
            >
              SUBSCRIBE
            </button>
          ...
          <p className="mt-5 text-[10px] leading-5 text-black/35">
            Email subscription will be activated when Aureon’s newsletter
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_0.8fr]">
            ...
            <div className="rounded-3xl border border-black/10 bg-white p-8 sm:p-10">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-7 flex w-full items-center justify-center rounded-full border border-black/15 px-6 py-3.5 text-xs font-medium tracking-[0.15em] transition hover:border-black hover:bg-[#f8f7f4]"
              >
                OPEN MESSENGER
              </a>
      ...
      <footer className="border-t border-black/5 bg-[#f8f7f4]">
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-6 px-6 py-10 text-center sm:flex-row sm:items-center sm:justify-between sm:text-left lg:px-10">
          ...
          <div className="flex flex-col items-center gap-2 text-xs text-black/40 sm:items-end">
